   ...
   if(r == 0)
     {
          ...
          count++;
          cout<<id<<" "<<name<<" "<<position<<"  "<<age<< " "  <<hours  <<" "  <<position<<" "  << payrate<<" "  << taxrate<<  endl;
		 k = true;
			...
			cin.getline(input , 25);
		     ...
		     file.getline(payrate,25);
		      ...
		      if(r==0)
		       {
				   a =true ;
			      cout<<id<<" "<<name<<" "<<age<<" "<<salary<<" "<<hours<<" "<<position<<" "<<taxrate<<" "<<payrate<<" "<< endl;
		       }
			 }
			if  (a== false)
			{
	...
	void Trainee::Counter(int c)
{
	...
	cout<<"Enter 3 if you want to count by  age"<<endl;
